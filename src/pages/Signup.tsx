...
export default function Signup() {
  ...
  return (
    <div className="flex min-h-screen bg-slate-900 font-sans text-slate-100">
      {/* Visual Left Side */}
      <div className="hidden w-1/2 flex-col justify-between bg-gradient-to-br from-indigo-600 via-purple-700 to-slate-900 p-12 lg:flex relative overflow-hidden">
        ...
        <div className="z-10 text-sm font-medium text-indigo-200">
